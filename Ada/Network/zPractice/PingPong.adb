...
procedure PingPong is
	-- Multi-cast group: administratively scoped IP address
  ...
  begin
    ...
    Set_Socket_Option(Socket, IP_Protocol_For_IP_Level, (Multicast_TTL, 1));
    -- Want the data you send to be looped back to your host.
    Set_Socket_Option(Socket, IP_Protocol_For_IP_Level, (Multicast_Loop, True));
