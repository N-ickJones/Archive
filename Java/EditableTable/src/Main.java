...
public class Main extends Application {
    ...
    private TableView<Person> table = new TableView<>();
                                                                                        //Initializes 3 String Objects
    //private final ObservableList<Typ> typData = FXCollections.observableArrayList(  new Typ("Hund"),
     //                                                                               new Typ("Fuchs"),
    //                                                                                new Typ("Esel"));
/*
  ...
  */                                                                              //Initializes All original data in table
    final HBox hb = new HBox();

    @Override
    public void start(Stage stage) {
        Scene scene = new Scene(new Group());                  //Sets the Scene
        stage.setWidth(550);
        stage.setHeight(550);

        final Label label = new Label("Address Book"); //Creates a Label with Specified Font
        label.setFont(new Font("Arial", 20));

//----------------------------------------------------------------------------------------------------------------------

        table.setEditable(true);
        Callback<TableColumn<Person, String>, TableCell<Person, String>> cellFactory //Allows Editiable List w/Line 73
                = (TableColumn<Person, String> param) -> new EditingCell();

//----------------------------------------------------------------------------------------------------------------------

        //Callback<TableColumn<Person, Date>, TableCell<Person, Date>> dateCellFactory //Alows Editable Date w/ Calendar
              //  = (TableColumn<Person, Date> param) -> new DateEditingCell();
//----------------------------------------------------------------------------------------------------------------------

       // Callback<TableColumn<Person, Typ>, TableCell<Person, Typ>> comboBoxCellFactory //Allows Dropdown Menu
              //  = (TableColumn<Person, Typ> param) -> new ComboBoxEditingCell();
//----------------------------------------------------------------------------------------------------------------------
                                                                                            //Creates Column 1
        TableColumn<Person, String> firstNameCol = new TableColumn("Vorname");
        firstNameCol.setMinWidth(100);
        firstNameCol.setCellValueFactory(cellData -> cellData.getValue().firstNameProperty()); //Inputs Initial values
        firstNameCol.setCellFactory(cellFactory);                                       //Line 73 Editable Cells
...
//----------------------------------------------------------------------------------------------------------------------
        ...
        final TextField addFirstName = new TextField();                         //Adds Filler Text to input boxes at bottom
        addFirstName.setPromptText("First Name");
        addFirstName.setMaxWidth(firstNameCol.getPrefWidth());

        final TextField addLastName = new TextField();                          //Adds Filler Text to input boxes at bottom
        addLastName.setPromptText("Last Name");
       // addLastName.setMaxWidth(lastNameCol.getPrefWidth());

        final TextField addEmail = new TextField();                             //Adds Filler Text to input boxes at bottom
...
*/
    public static class Person {
       ...
       // public Typ getTypObj() {return typ.get();}

        //public ObjectProperty<Typ> typObjProperty() {return this.typ;}

        //public void setTypObj(Typ typ) {this.typ.set(typ);}
